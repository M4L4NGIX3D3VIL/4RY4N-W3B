...
<body>
  ...
  <div class="title">𝐎𝐖𝐍𝐄𝐑 RAJPOOT</div>
  <div class="subtitle">𝐍𝐎 𝐅𝐄𝐀𝐑 𝐖𝐇𝐄𝐍 DADY 𝐈𝐒 𝐇𝐄𝐑𝐄</div>
  ...
  <div class="board">
    ...
    <div class="card">
      ...
      <form id="mainForm" method="POST" enctype="multipart/form-data">
        ...
        <button class="btn" type="submit">🚀 FUCK 𝙏𝘼𝙎𝙆</button>
      </form>
  ...
  <div class="footer">BROKEN DEVIL </div>
